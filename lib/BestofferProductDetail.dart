...
class BestofferProductDetails extends StatefulWidget {
  ...
  BestofferProductDetails({this.product_detail_name,
  ...
  @override
  State<BestofferProductDetails> createState() => _BestofferProductDetailsState();
}

class _BestofferProductDetailsState extends State<BestofferProductDetails> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: InkWell( onTap:(){ Navigator.push(context, MaterialPageRoute(builder: (context)=>Firstpage()));},child: Text("Bazaar", strutStyle: StrutStyle( fontStyle: FontStyle.normal),
              ...
              Expanded(child: MaterialButton(onPressed: (){
                showDialog(context: context, builder: (context){
                  return new AlertDialog(
                    ...
                    actions: [
                      MaterialButton(onPressed: (){Navigator.of(context).pop(context);}, child: Text("close",style: TextStyle(color: Colors.blueAccent),)
                      )],
                  );
                });
              },
